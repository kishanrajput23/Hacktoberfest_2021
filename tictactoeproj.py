...
def AutoPlay():
    ...
    try:
        ...
        ButtonClick(Empty &  # 91;RandIndex])
    except:
        pass
...
def EnableAll():
    b1.config(text=" ")
    b1.state( &  # 91;'!disabled'])
    b2.config(text=" ")
    b2.state( &  # 91;'!disabled'])
    b3.config(text=" ")
    b3.state( &  # 91;'!disabled'])
    b4.config(text=" ")
    b4.state( &  # 91;'!disabled'])
    b5.config(text=" ")
    b5.state( &  # 91;'!disabled'])
    b6.config(text=" ")
    b6.state( &  # 91;'!disabled'])
    b7.config(text=" ")
    b7.state( &  # 91;'!disabled'])
    b8.config(text=" ")
    b8.state( &  # 91;'!disabled'])
    b9.config(text=" ")
    b9.state( &  # 91;'!disabled'])
